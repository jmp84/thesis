...
% TODOSUBMIT fix table g1-g4 margin right
% TODOSUBMIT check about G1-G4
% TODOFINAL check too much blank space
% TODOFINAL notation for phrase pairs brackets (grep for '(f' for example)
% TODOSUBMIT do something about G_3 and G_4 used sometimes and sometimes not
...
% TODOSUBMIT describe here hefaestus config
...
the minimum source-to-target probability. % TODOSUBMIT clarify and refer to background rule filtering thresholds
