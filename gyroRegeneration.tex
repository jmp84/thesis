...
% TODOSUBMIT British vs US spelling
...
% TODOSUBMIT finish sig tests for wmt chapter
% TODOFINAL maybe do sig tests for this chapter
% TODOSUBMIT grep for sec:optimization and replace with sec:evaluationMetrics where appropriate
...
% TODOSUBMIT compare our system to this performance update this performance with a better system or with rescored system
...
framework as implemented by Hadoop in order to extract % TODOSUBMIT refer to background
...
For experiments, we extract $n$-grams from order 1 to 5. % TODOFINAL : in one instance we extracted 6-grams, made no difference
...
but not in decoding. % TODOSUBMIT check this claim
