...
% needed when using \Call in an algorithm
\MakeRobust{\Call}
...
pdfauthor="Juan Pino", 
pdfsubject="Refinements in Hierarchical Phrase-Based Translation Systems", %subject of the document
pdftoolbar=true, % toolbar active
