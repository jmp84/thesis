...
%TODOSUBMIT: distinguish lm, tm, linear, loglinear
...
% TODOSUBMIT add this to background + refer to background
...
lexical features are computed for each provenance. % TODOSUBMIT ref lex feature background
...
When retrieving relevant rules for a particular test set, various thresholds are applied, such % TODOSUBMIT as described in section...
...
% TODOSUBMIT significance testing
