...
% TODO review preamble and correct pdfinfo
% TODO grep for chunk and maybe rephrase
% TODO grep for lmbr and harmonize capitalization
% TODO grep for data and replace by text where appropriate
% TODO grep for stupid and put capital S
% TODO grep for CUED and Cambridge University Engineering Department
% TODO harmonize notation for NIST openMT etc.
% TODO grep for config and replace with configuration
...
in the target-to-source direction, the maximum size of an English phrase is 4. % TODO ask Bill for confirmation and/or any justification (citation ?)
...
% TODO check NgramGen naming (vs. gyro and capitalization also)
